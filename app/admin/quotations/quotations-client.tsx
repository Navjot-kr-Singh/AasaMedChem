...
export function AdminQuotationsClient({ initialQuotations }: Props) {
        ...
        <div className="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden">
          <div className="p-6 border-b border-slate-100 flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-sm font-bold text-slate-850 uppercase tracking-wider">B2B Quotation Requests</h3>
            </div>
          ...
          {quotesList.length === 0 ? (
            <div className="p-12 text-center text-slate-400">
              ...
              <p className="text-sm font-medium">No quotation requests logged in the system.</p>
            </div>
          ) : (
              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="bg-slate-50/70 border-b border-slate-100 text-[10px] font-bold text-slate-500 uppercase tracking-wider">
                    ...
                    <th className="px-6 py-3">Estimated Total</th>
          ...
          <div className="bg-white border border-slate-200 rounded-2xl shadow-sm p-6 space-y-6 sticky top-24">
            ...
            {selectedQuote.status === "approved" && (
              <div className="p-3 bg-green-50 border border-green-150 rounded-xl text-xs text-green-700 flex items-start gap-2">
                ...
                <div>
                  <span className="font-bold">Active Reservation:</span> Stock quantities are currently locked. Awaiting buyer checkout conversion.
                </div>
              </div>
            )}
            ...
            <div className="space-y-3">
              <p className="text-[10px] font-bold text-slate-450 uppercase tracking-wider">Requested Items Spec</p>
              {loadingItems ? (
        ...
        <div className="fixed inset-0 z-50 bg-slate-900/40 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-white border border-slate-200 rounded-2xl max-w-md w-full p-6 shadow-xl space-y-4">
            <div>
              ...
              <p className="text-xs text-slate-500 mt-0.5">Optionally provide feedback reason for the buyer customer.</p>
            </div>
            ...
            <textarea
              ...
              placeholder="e.g., Requested quantity exceeds maximum threshold for chemical safety compliance. Please submit a reduced request."
            />
            ...
            <div className="flex gap-2 justify-end">
              ...
              <button
                ...
                disabled={isPending}
                className="px-4 py-2 bg-red-650 hover:bg-red-700 disabled:bg-red-400 text-white rounded-lg text-xs font-semibold transition-all shadow-sm hover:shadow cursor-pointer"
              >
                Reject Request
              </button>
            </div>
