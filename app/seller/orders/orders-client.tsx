...
export function SellerOrdersClient({ initialOrders }: Props) {
        ...
        <div className="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden">
          <div className="p-6 border-b border-slate-100 flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <h3 className="text-sm font-bold text-slate-855 uppercase tracking-wider">Orders Received</h3>
            </div>
        ...
        {selectedOrder ? (
          <div className="bg-white border border-slate-200 rounded-2xl shadow-sm p-6 space-y-6 sticky top-24">
            ...
            <div className="space-y-2">
              ...
              <div className="bg-slate-50 border border-slate-100 rounded-xl p-3.5 space-y-2 text-xs text-slate-700">
                ...
                {selectedOrder.quotationId && (
                  <div className="flex items-center gap-2 pt-2 border-t border-slate-100 text-[10px] text-indigo-650 font-mono font-bold">
            ...
            <div className="space-y-3">
              <label className="text-[10px] font-bold text-slate-450 uppercase tracking-wider block">Update Order Status</label>
            ...
            <div className="space-y-3">
              <p className="text-[10px] font-bold text-slate-450 uppercase tracking-wider">Items summary</p>
              {loadingItems ? (
